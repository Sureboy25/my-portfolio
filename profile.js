...
form.addEventListener("submit", async function(e){
    ...
    try{
        ...
        if(response.ok){
            message.innerHTML = '<i class="fa-solid fa-circle-check"></i> Message sent successfully!';message.style.color="lightgreen";
            form.reset();
        }else{
            message.innerHTML = '<i class="fa-solid fa-circle-xmark"></i> Failed to send message.';message.style.color="red";
        }
    }catch(error){
        message.innerHTML ='<i class="fa-solid fa-triangle-exclamation"></i> Network error. Try again.';message.style.color="red";
    }
    setTimeout(()=>{
        message.innerHTML="";
    },5000);
